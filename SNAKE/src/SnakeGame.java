...
public class SnakeGame extends JPanel implements ActionListener, KeyListener, MouseListener {
    ...
    SnakeGame(int boardWidth, int boardHeight) {
        ...
        // game timer
        gameLoop = new Timer(144, this); // how long it takes to start timer, milliseconds gone between frames
        gameLoop.start();
    ...
    public void resumeGame() {
        if (!gameOver) {
            gameLoop.start();
            requestFocusInWindow(); // Request focus after resuming the game
        }
    }
